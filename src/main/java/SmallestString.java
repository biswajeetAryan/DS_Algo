...
public class SmallestString {
    public static void main(String[] args) {
        ...
        SolutionSmallestString obj = new SolutionSmallestString();
...
//        while (true){
//            if(n == 1)
//                return String.valueOf(Character.toChars(96+k));
//            if(k<=d)
//                d=k;
//
//            if((k-d) >= (n-1)){
//                return getSmallestString(n-1,k-d)+String.valueOf(Character.toChars(96+d));
//            }else {
//                d--;
//            }
//        }
